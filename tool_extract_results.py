    ...
    with open(args.input_file, 'r', encoding='utf-8') as f_in, \
        ...
        for line in tqdm(f_in, desc="Processing"):
            ...
            new_record = {
                ...
                "model_tooltrace": data.get("model_tooltrace", []),
                "evaluation_result": data.get("evaluation_result", {
                    "reasoning": "", 
                    "matched_ids": []
                }),
                "tool_evaluation_result": data.get("tool_evaluation_result", {
                    "tool_reasoning": "", 
                    "tool_matched_ids": []
                }),
                ...
                "tool_overall_score": tool_metrics.get("score_overall", None),
                "tool_answer_score": tool_metrics.get("score_final", None),
            }
            
            f_out.write(json.dumps(new_record, ensure_ascii=False) + "\n")
            extracted_count += 1

    print(f"✅ Extraction complete! Processed {extracted_count} records.")
